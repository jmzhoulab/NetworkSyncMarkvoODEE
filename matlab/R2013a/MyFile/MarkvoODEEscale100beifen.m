...
tanh=0.5;     %控制强度
% L=zeros(nodenum,nodenum);
% L(26:50,1:25)=binornd(1,0.02,25,25);
% L(51:75,26:50)=binornd(1,0.2,25,25);
% L(76:100,51:75)=binornd(1,0.2,25,25);
% L(76:100,1:25)=binornd(1,0.02,25,25);
% uL=triu(L')-diag(diag(L));
% L1=diag(sum(uL+uL'))-uL-uL';
% L2=L1;
% L3=L1;
% L1=L;L2=L;L3=L;
